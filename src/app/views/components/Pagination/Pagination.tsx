...
export default function Pagination({
  ...
  return (
    <div className="mt-[45px] md:px-10 py-4 w-full md:bg-[#F4F7F9] ">
        ...
        <div>
          ...
          >
           ...
           ${currentPage <= 1 ? "bg-[#C8CCD0]" : "bg-[#ffffff]"}
              ...
              aria-disabled={currentPage <= 1}
            >
              <Image src={GreenLeftArrow} alt="" height={16} width={16} />
            </a>
            ...
            <a
              ...
              className={`relative inline-flex items-center px-2 py-2 rounded-full w-8 h-8  text-sm font-[200] text-white hover:bg-opacity-90 cursor-pointer  ${
                currentPage >= totalPages ? "bg-[#C8CCD0]" : "bg-primaryBlue"
              }`}
            >
              <Image src={WhiteRightArrow} alt="" height={16} width={16} />
            </a>
          </nav>
        </div>
      </div>
